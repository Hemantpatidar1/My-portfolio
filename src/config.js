export const config = {
  ...
  workExperience: [
    {
      ...
      points: [
        "Worked on a Hostel management system under some seniors and team.",
         "There I learnt HTML CSS and tried to contribute to the project.",
      ],
    },
    // {
  ...
  academics: [
    ...
    {
      name: "Class XII (RBSE Board)",
      duration: "July 2018 - May 2019",
      instituteName: "Shiv Jyoti Sr. Sec. School",
      location: "Talwandi ,Kota",
      result: "Percentage: 75.2",
    },
    {
      name: "Class X (CBSE Board)",
      duration: "April 2016 - April 2016",
      instituteName: "Flower Kids Sr.Sec. School",
  ...
  // <------------------------  contact section  -------------------->
  email: "hpatidar881@gmail.com",
  phone: "8696257900",
  linkedinUrl: "https://www.linkedin.com/in/hemant-patidar/",
  githubUrl: "https://github.com/Hemantpatidar1",
  // fbUrl: " ",
  instaUrl: "",
};
